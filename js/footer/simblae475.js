...
L = window['L'] || function(k) { return k; }
var Simbla = (function() {
    if (!window['Parse'])
        return;
    var _simbla = Parse;
    ...
    _simbla.Query.prototype.aggregate = function(groupby, group, groupcomplex) {
        ...
        var d = { where: this._where, groupby: groupby, limit: limit, order: this._order };
...
function addCriteriaToQuery(q, cls, o) {
    try {
        ...
        try {
            o.trigger('criteria-added-to-query', { query: q, class: cls, object: o })
        } catch (e) {
            console.error(e);
        ...
        addCriteriaToQuery(query, cls, c).aggregate(groupby, group).then(function(results) {
            ...
            if (Array.isArray(data) || chartType == "pie") {
                ...
                if (chartType !== "pie" && (!options || !options.legend)) {
                    options = $.extend(true, {}, options, { legend: { display: false } });
                }
            } else {
...
function getSelectPointers(targetClass, selectfields, value, T, name) {
    ...
    function setResult(d) {
        ...
        try {
            T.trigger("select-options-loaded", { val: val, options: d })
